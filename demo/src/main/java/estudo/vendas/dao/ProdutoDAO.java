...
public class ProdutoDAO {
    public boolean salvarProduto(Produto produto) {
        ...
        String query = "INSERT INTO produto (nome_produto, preco_produto, qtde_estoque, id_categoria) VALUES (?, ?, ?, ?)";
    ...
    public boolean alterarProduto(Produto produto_antigo, Produto produto_novo) {
        String query = "UPDATE produto SET (nome_produto, preco_produto, qtde_estoque, id_categoria) = (?, ?, ?, ?) WHERE (id_produto) = (?)";
        PreparedStatement stmt = null;
        ...
        try {
            ...
            stmt.setInt(5, produto_antigo.getId_produto());
